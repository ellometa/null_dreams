...
void solve() {
    in(n);
    // if 1 at start, all following zero will need to be 1
    // if 1 at end, all zeros between the first occuring 1 and n-1 index need to be 1
    // if 0 at start
    // if 0 at end, change 0 assuming theres a 1 before and then 1 at end case
