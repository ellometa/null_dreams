...
void solve(){
    ...
    // cout << ax << " " << ay << " " << bx << " " << by nline;

    int cnt = 0;
    if(by - ay >= bx - ax){ // possible maybe
        // cout << by-ay;
        ax+=(by-ay); // ax = (-1) + 2 - 0 = 1, 0
        cnt+=(by-ay); // 2
        // cout << "why";
        ay = by; // 1, 2

        // bring to same y coord, will increase ax
        // then move left to achieve same x coord
    ...
    cout << cnt nline;
    // slope from a to b should be 1 or more than 1
